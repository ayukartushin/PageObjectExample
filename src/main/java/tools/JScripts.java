...
public class JScripts {
    ...
    // Скрипты для визуального выделения элементов
    private static final String BORDER_ON  = "arguments[0].style.border='2px solid red'";
    private static final String BORDER_OFF = "arguments[0].style.border='none'";
    ...
    public void highlight(WebElement element) {
        run(BORDER_ON, element);
    }

    // Убрать подсветку
    public void unhighlight(WebElement element) {
        run(BORDER_OFF, element);
    }
